...
Java_com_skipkou_rtmplib_rtmp_RtmpHelper_n_1init(JNIEnv *env, jobject instance,
                                                 jstring url_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_skipkou_rtmplib_rtmp_RtmpHelper_n_1pushSPSPPS(JNIEnv *env, jobject instance,
                                                       jbyteArray sps_,
                                                       jint spsLen, jbyteArray pps_,
                                                       jint ppsLen) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_skipkou_rtmplib_rtmp_RtmpHelper_n_1pushVideoData(JNIEnv *env, jobject instance,
                                                          jbyteArray data_,
                                                          jint dataLen,
                                                          jboolean keyFrame) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_skipkou_rtmplib_rtmp_RtmpHelper_n_1pushAudioData(JNIEnv *env, jobject instance,
                                                          jbyteArray data_,
                                                          jint dataLen) {
    jbyte *data = env->GetByteArrayElements(data_, NULL);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_skipkou_rtmplib_rtmp_RtmpHelper_n_1stop(JNIEnv *env, jobject instance) {
